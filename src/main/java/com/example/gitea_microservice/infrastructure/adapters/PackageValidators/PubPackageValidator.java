...
@Component
public class PubPackageValidator implements PackageValidatorPort{
private final PackageManager supportedManager = PackageManager.PUB;
    @Override
    ...
    public PublishType validate(MultipartFile file) throws InvalidPackageException {
        if (!file.getOriginalFilename().endsWith(".tar.gz")) {
            throw new InvalidPackageException(
                ...
                HttpStatus.UNPROCESSABLE_ENTITY, "Pub-package must be .tar.gz"
