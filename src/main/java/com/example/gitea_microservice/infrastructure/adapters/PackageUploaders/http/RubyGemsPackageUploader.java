...
@Component
public class RubyGemsPackageUploader extends AbstractHttpPackageUploader{
    ...
    public  RubyGemsPackageUploader(GiteaClientAdapter giteaClient,
    ...
    protected void doUpload(PackageManager manager, MultipartFile file, String version) {
        ...
        giteaClient.uploadRubyGemsPackage(pkg);
    }
